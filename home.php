...
//     exit();
// }
// if(!isset( $_SESSION['loggedin_as_pracownik'])){
//     header('Location: index.php');
//     exit();
// }
?>
...
<body>
    ...
    <section class="main col-12 fs-2 position-absolute ">
        ...
        <div class="napis text-center ">
            ...
            <div class="witamy d-sm-block d-md-block d-lg-none d-xl-none d-xxl-none">
            <?php
                echo "Witaj,  ".$_SESSION['username']; 
                // pobieranie nazwy użytkownika za pomocą sesji
                ?>
               <i class="fa-solid fa-user"></i> <br/> </div> 

            

            
            <div class="witamy2 d-none d-lg-block ">
            ...
            <form action="zlozzamowienie.php" method="post">
            <button type="submit" name="zamowienie" class="przycisk shadow fs-4 p-3">
                <a href="zamowienia.php">Złóż zamówienie</a>
            </button>
            <button type="submit" name="status" class="przycisk shadow fs-4 p-3">
                <a href="zamowienia.php">Status zamówienia</a></button>
            </form>
    ...
    <section class="menudania row container-fluid col-12 col-md-9 col-lg-8 col-xl-7 col-xxl-6 mx-auto">
        ...
        <h4 class="">Nr</h4>  <br/>
            ...
            <!-- pobieranie wartości z bazy danych w tabeli dania -->
    ...
    <section class="dodaj row container-fluid col-12 col-md-9 col-lg-8 col-xl-7 col-xxl-6 mx-auto">
    <?php
    //sprawdzenie, czy użytkownik zalogowany jest jako pracownik, żeby treści były widoczne tylko dla pracowników 
    if(isset($_SESSION['loggedin_as_pracownik']))
    {
          echo($_SESSION['loggedin_as_pracownik']);
        
   };
//Komunikaty o wykonaniu zapytania
    if(isset($_SESSION['udane']))
    {
        echo($_SESSION['udane']);
    }
    else if(isset($_SESSION['nieudane']))
    {
        echo($_SESSION['nieudane']);
    }
    ?>
    </section>
